$(function () {
  ...
  function select2Img(data) {
    ...
    var $data = $(
      '<span class="d-flex align-items-center"><img src="../assets/img/crypto-currencies/round-icons/' + data.element.value + '.svg" class="ht-20 wd-20 me-1" /> '
      + data.text + '</span>'
    );
    return $data;
  };
...
var chart1 = new ApexCharts(document.querySelector("#cryptoReport"), options);
chart1.render();
