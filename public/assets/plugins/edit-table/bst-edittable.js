    ...
    constructor(tableId, options) {
        ...
        var defaults = {
            ...
            advanced: { // Do not override advanced unless you know what youre doing
                columnLabel: 'Actions',
                buttonHTML: `<div class="d-flex align-items-center">
                <button id="bEdit" type="button" class="btn btn-sm btn-def tx-muted">
                    <i class="fe fe-edit" > </i>
                </button>
                <button id="bDel" type="button" class="btn btn-sm btn-def tx-muted">
                    <i class="fe fe-trash-2" > </i>
                </button>
                <button id="bAcep" type="button" class="btn btn-sm btn-def tx-muted" style="display:none;">
                    <i class="fe fe-check-circle" > </i>
                </button>
                <button id="bCanc" type="button" class="btn btn-sm btn-def tx-muted" style="display:none;">
